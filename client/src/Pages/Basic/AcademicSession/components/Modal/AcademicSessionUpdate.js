...
const AcademicSessionUpdate = (props) => {
  ...
  //   context inclusiion
  const { editAcademicSessionById, academicSession } = useContext(AcademicSessionContext);
  ...
  const [academicYear, setAcademicYear] = useState(academicSessions[0].academicYear);
